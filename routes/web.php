...
Route::prefix('admin')->group(function (): void {
    ...
    Route::middleware('admin.auth')->group(function (): void {
        ...
        Route::delete('/orders/{order}', [OrdersController::class, 'destroy'])->middleware('role:owner,manager')->name('admin.orders.destroy');

        Route::get('/invoices', [InvoicesController::class, 'index'])->middleware('role:owner,manager,staff')->name('admin.invoices.index');
        Route::post('/invoices/direct', [InvoicesController::class, 'storeDirectSale'])->middleware('role:owner,manager,staff')->name('admin.invoices.direct');
        Route::post('/invoices/from-order/{order}', [InvoicesController::class, 'createFromOrder'])->middleware('role:owner,manager,staff')->name('admin.invoices.from-order');
        ...
        Route::post('/invoices/{invoice}/payments', [InvoicesController::class, 'addPayment'])->middleware('role:owner,manager,staff')->name('admin.invoices.payments.store');

        Route::get('/products', [CatalogController::class, 'products'])->middleware('role:owner,manager')->name('admin.products.index');
        Route::post('/products', [CatalogController::class, 'storeProduct'])->middleware('role:owner,manager')->name('admin.products.store');
        Route::get('/products/{product}', [CatalogController::class, 'showProduct'])->middleware('role:owner,manager')->name('admin.products.show');
        Route::post('/products/{product}/stock', [CatalogController::class, 'adjustStock'])->middleware('role:owner,manager')->name('admin.products.stock.adjust');

        Route::get('/suppliers', [CatalogController::class, 'suppliers'])->middleware('role:owner,manager')->name('admin.suppliers.index');
        Route::post('/suppliers', [CatalogController::class, 'storeSupplier'])->middleware('role:owner,manager')->name('admin.suppliers.store');

        Route::get('/purchases', [CatalogController::class, 'purchases'])->middleware('role:owner,manager')->name('admin.purchases.index');
        Route::post('/purchases', [CatalogController::class, 'storePurchase'])->middleware('role:owner,manager')->name('admin.purchases.store');

        Route::get('/expenses', [FinanceController::class, 'expenses'])->middleware('role:owner,manager')->name('admin.expenses.index');
        Route::post('/expenses', [FinanceController::class, 'storeExpense'])->middleware('role:owner,manager')->name('admin.expenses.store');

        Route::get('/employees', [FinanceController::class, 'employees'])->middleware('role:owner,manager')->name('admin.employees.index');
        Route::post('/employees', [FinanceController::class, 'storeEmployee'])->middleware('role:owner,manager')->name('admin.employees.store');
        Route::post('/employees/payroll/monthly', [FinanceController::class, 'storeMonthlyPayroll'])->middleware('role:owner,manager')->name('admin.employees.payroll.monthly');
        ...
        Route::post('/employees/financials', [FinanceController::class, 'storeEmployeeFinancial'])->middleware('role:owner,manager')->name('admin.employees.financials.store');

        Route::get('/customers', [CustomersController::class, 'index'])->middleware('role:owner,manager,staff')->name('admin.customers.index');
        Route::post('/customers', [CustomersController::class, 'store'])->middleware('role:owner,manager,staff')->name('admin.customers.store');
        ...
        Route::post('/settings/main', [SettingsController::class, 'updateMain'])->middleware('role:owner,manager')->name('admin.settings.main.update');
        Route::post('/settings/zones', [SettingsController::class, 'storeZone'])->middleware('role:owner,manager')->name('admin.settings.zones.store');
        Route::post('/settings/colors', [SettingsController::class, 'storeColor'])->middleware('role:owner,manager')->name('admin.settings.colors.store');
